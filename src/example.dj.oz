...
% Brabanconne
  ...
  MainGauche2= [etirer(facteur:2.0 silence)  %1
   ...
   BellsDroite = [etirer(facteur:0.5 [b4 b4]) b4 etirer(facteur:0.5 [b4 b4]) b4 etirer(facteur:0.5 [b4 d5]) etirer(facteur:0.75 g4) etirer(facteur:0.25 a4) %1
		  etirer(facteur:2.0 b4) etirer(facteur:0.5 [c5 c5]) etirer(facteur:0.75 c5) etirer(facteur:0.25 c5) etirer(facteur:0.5 [c5 b4 b4]) etirer(facteur:0.25 [b4 b4]) %2
		  ...
		  etirer(facteur:0.5 [c5 c5]) etirer(facteur:0.75 c5) etirer(facteur:0.25 c5) etirer(facteur:0.5 [c5 b4 b4]) etirer(facteur:0.25 [b4 b4]) etirer(facteur:0.5 [d5 d5 c5 a4]) etirer(facteur:2.0 g4) %5
		 ]
