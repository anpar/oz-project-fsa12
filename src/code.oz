...
local Mix Interprete Projet CWD in
   ...
   % Si vous utilisez Mozart 1.4, remplacez la ligne pr̩c̩dente par celle-ci :
   ...
   % {Projet.load 'music_file.dj.oz'} = La valeur oz contenue dans le fichier charg̩ (normalement une <musique>).
   %
   % et une constante :
   % Projet.hz = 44100, la fr̩quence d'̩chantilonnage (nombre de donn̩es par seconde)
